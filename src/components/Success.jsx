...
function Success() {
  ...
  return (
    <div className="success__container__">
      ...
      <section className="section__success">
        <div className="success__container">
          ...
          <p className="heading__primary submit__text">Success Submitted</p>
          <h2 className="heading__secondary">Congratulations</h2>
        ...
        <div className="redirect__container">
          <p className="redirect__text">
            Redirecting you to Homepage in <span>{seconds} Seconds</span>
          </p>
        </div>
      </section>
    </div>
